...
import com.luo.a10.fileselect.bean.FileResultInfo;
import com.luo.a10.fileselect.emnu.Type;
import com.luo.a10.fileselect.imageLoader.ImageLoader;
import com.luo.a10.fileselect.imageLoader.VideoThumbnailLoader;
...
//        tvTime.setText(fileItem.getDataDate());
        switch (fileType) {
            case VIDEO:
                ...
                break;
            case AUDIO:
                iv.setImageResource(R.drawable.icon_type_mp3);
                break;
            case IMAGE:
