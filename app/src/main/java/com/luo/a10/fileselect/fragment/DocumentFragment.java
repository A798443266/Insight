package com.luo.a10.fileselect.fragment;
...
import com.luo.a10.fileselect.emnu.Type;
import java.io.File;
import java.util.Collections;
import java.util.List;

public class DocumentFragment extends Base1Fragment {
    @Override
    ...
    public boolean scannerFile(String path) {
        ...
        if (file.exists() && file.length() > 0) {
            ...
            boolean flag = name.endsWith(".docx") || name.endsWith(".doc") || name.endsWith(".ppt")
                    || name.endsWith("pptx") || name.endsWith(".pdf") || name.endsWith(".xlsx");
            return flag;
        }
        return false;
    }
