...
public class VideoAdapter extends BaseAdapter {
    ...
    public VideoAdapter(Context context, List<FolderAndDoc> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = View.inflate(context, R.layout.item_fenlei_video,null);
        ...
        Glide.with(context).load(datas.get(position).getCover()).error(R.drawable.city1).into(holder.iv);
