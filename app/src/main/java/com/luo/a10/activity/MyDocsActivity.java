...
public class MyDocsActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        OkHttpUtils.get().url(Constant.Docinfo)
                .build().execute(new StringCallback() {
            @Override
            public void onError(Call call, Exception e, int id) {
                show();
                Toast.makeText(MyDocsActivity.this, "网络出错了", Toast.LENGTH_SHORT).show();
            }
        ...
        if (datas != null && datas.size() > 0) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent intent = new Intent(MyDocsActivity.this, DocSeeActivity.class);
